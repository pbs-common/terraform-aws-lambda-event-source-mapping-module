...
```hcl
github.com/pbs/terraform-aws-lambda-event-source-mapping-module?ref=0.1.17
```
...
module "lambda_event_source_mapping" {
  source = "github.com/pbs/terraform-aws-lambda-event-source-mapping-module?ref=0.1.17"
